...
[[ -f README.md ]] && cp -a README.md "backups/README.md.${TS}.final.bak" || true
...
echo "OK: README.md rewritten (final)."
sed -n '1,120p' README.md

git add README.md
git commit -m "docs: polish README" >/dev/null
echo "OK: committed: docs: polish README"
git log -3 --oneline
