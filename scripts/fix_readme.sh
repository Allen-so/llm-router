...
[[ -f README.md ]] && cp -a README.md "backups/README.md.${TS}.bak" || true
...
echo "OK: README.md rewritten."
echo
echo "----- README preview (top 60 lines) -----"
sed -n '1,60p' README.md
echo "----------------------------------------"

git add README.md
git commit -m "docs: fix README formatting" >/dev/null
echo "OK: committed: docs: fix README formatting"
git log -3 --oneline
